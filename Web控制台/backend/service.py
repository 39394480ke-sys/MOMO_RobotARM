    ...
    def _get_subject_lock_controller(self) -> Any:
        ...
        controller = SubjectLockController(
            ...
            config={
                ...
                "tilt_sign": float(follow_cfg.get("tilt_sign", 1.0)),
                "tilt_center_max_speed_deg_s": float(follow_cfg.get("max_tilt_speed_deg_s", 10.0)),
                "tilt_center_max_accel_deg_s2": float(follow_cfg.get("tilt_accel_deg_s2", 25.0)),
