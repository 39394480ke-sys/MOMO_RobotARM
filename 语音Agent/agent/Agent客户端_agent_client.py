...
def create_agent_client(config: dict[str, Any], force_new_session: bool = False) -> AgentClient:
    ...
    if backend == "openai_compatible":
        ...
        return OpenAICompatibleAgentClient(config, force_new_session=force_new_session)
    if backend == "nanobot":
