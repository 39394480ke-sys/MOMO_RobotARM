...
def 计算IK(
    ...
    try:
        ...
        result = model.inverse(
            target_xyz=xyz,
            target_rpy=rpy,
            seed_q_user=[math.radians(float(value)) for value in seed],
        ...
        output = {
            ...
            "solution_joints_deg": {
                name: math.degrees(float(result["q_user_rad"][idx]))
...
def main() -> int:
    ...
    parser.add_argument("--seed-deg", nargs=5, type=float, metavar=("J1", "J2", "J3", "J4", "J5"))
